-- =====================================================
-- READY TO RUN - Sample Data Script
-- Just copy ALL of this and run in Supabase SQL Editor
-- =====================================================
...
BEGIN
  ...
  INSERT INTO applications (
    ...
    (
      v_project1_id, 
      v_worker_id, 
      'Hello! I have extensive experience in React and Node.js. Would love to work on this e-commerce project!', 
      1200, 
      'pending'
    ),
    (
      v_project2_id, 
      v_worker_id, 
      'I can create a stunning landing page for you with modern animations!', 
      1200, 
      'accepted'
    );
  ...
  RAISE NOTICE '';
  RAISE NOTICE '📝 Contract ID for testing: %', v_contract_id;
  RAISE NOTICE '';
...
SELECT 
  ...
  (SELECT user_type FROM users WHERE email = 'ram3sh.akula@gmail.com') as admin_status;
