    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center gap-8">
              <Link href="/about" className="text-slate-600 hover:text-[#0b63ff] font-medium transition">About</Link>
              <Link href="/contact" className="text-slate-600 hover:text-[#0b63ff] font-medium transition">Contact</Link>
            </div>
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50 to-slate-50">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-blue-100 text-[#0a56e6] px-4 py-2 rounded-full text-sm font-semibold mb-6">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-slate-50">
        <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <span className="px-3 py-1 bg-blue-100 text-[#0a56e6] rounded-full text-sm font-semibold">
                        {job.department}
                      </span>
                    </div>
                  ...
                  <Link
                    ...
                    className="bg-gradient-to-r from-[#0b63ff] to-[#0a56e6] text-white px-8 py-3 rounded-xl font-semibold hover:shadow-xl hover:scale-105 transition-all whitespace-nowrap"
                  >
                    Apply Now
                  </Link>
                </div>
          ...
          <div className="mt-12 text-center">
            ...
            <Link
              href="/contact"
              className="inline-block bg-white text-slate-900 px-8 py-3 rounded-xl font-semibold border-2 border-slate-200 hover:border-[#0b63ff] hover:shadow-lg transition-all"
            >
              Send Us Your Resume
            </Link>
          </div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#0b63ff] to-[#0a56e6]">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <Link
            href="/contact"
            className="inline-block bg-white text-[#0b63ff] px-10 py-4 rounded-xl font-bold text-lg hover:bg-blue-50 transition-all"
          >
            Get in Touch
          </Link>
        </div>
