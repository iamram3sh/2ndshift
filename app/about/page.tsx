        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden lg:flex items-center gap-1">
              ...
              <Link href="/employers" className="px-3 py-2 text-sm font-medium text-[#333] hover:text-[#111]">
                For Employers
              </Link>
              <Link href="/about" className="px-3 py-2 text-sm font-medium text-[#111] bg-slate-100 rounded-lg">
                About
              </Link>
              <Link href="/contact" className="px-3 py-2 text-sm font-medium text-[#333] hover:text-[#111]">
                Contact
              </Link>
            </div>
      ...
      <section className="py-20 lg:py-28 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl lg:text-4xl font-semibold text-[#111] mb-6">
                Our Story
              </h2>
              <div className="space-y-4 text-[#333] leading-relaxed">
                ...
                <p>
                  <strong className="text-[#111]">We built 2ndShift to change that.</strong> A platform where 
              ...
              <div className="space-y-6">
                {MILESTONES.map((milestone, i) => (
                  <div key={i} className="flex gap-4">
                    <div className="flex-shrink-0 w-16 text-sm font-semibold text-[#333]">
                      {milestone.year}
                    </div>
                    <div>
                      <div className="font-semibold text-[#111]">{milestone.title}</div>
                      <div className="text-sm text-[#333]">{milestone.description}</div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            {VALUES.map((value, i) => (
              <div key={i} className="bg-white p-6 rounded-xl border border-slate-200">
                <div className="w-12 h-12 bg-slate-100 rounded-xl flex items-center justify-center mb-4">
                  <value.icon className="w-6 h-6 text-[#111]" />
                </div>
                <h3 className="text-lg font-semibold text-[#111] mb-2">{value.title}</h3>
                <p className="text-[#333] text-sm">{value.description}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {TEAM.map((member, i) => (
              <div key={i} className="bg-white/5 rounded-xl p-6 border border-white/10 text-center">
                ...
                <p className="text-sm text-[#333]">{member.bio}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 lg:py-28 border-t border-slate-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 text-center">
            <h3 className="text-xl font-semibold text-[#111] mb-2">We&apos;re hiring!</h3>
            <p className="text-[#333] mb-4">
              Want to join our team? We&apos;re looking for passionate people to help us grow.
            </p>
            <Link
              href="/careers"
              className="inline-flex items-center gap-2 text-[#111] font-medium hover:text-sky-600"
            >
              View open positions
              <ArrowRight className="w-4 h-4" />
            </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-3 gap-8 text-center">
            <div>
              ...
              <h3 className="font-semibold text-[#111] mb-1">Email Us</h3>
              <p className="text-[#333]">hello@2ndshift.com</p>
            </div>
            <div>
              <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center mx-auto mb-4 border border-slate-200">
                <MapPin className="w-6 h-6 text-[#333]" />
              </div>
              <h3 className="font-semibold text-[#111] mb-1">Location</h3>
              <p className="text-[#333]">Hyderabad, India</p>
            </div>
            <div>
              <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center mx-auto mb-4 border border-slate-200">
                <Globe className="w-6 h-6 text-[#333]" />
              </div>
              <h3 className="font-semibold text-[#111] mb-1">Social</h3>
              <div className="flex items-center justify-center gap-4 mt-2">
                <a href="#" className="text-slate-400 hover:text-[#333]">
      ...
      <footer className="bg-white border-t border-slate-200 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm text-[#333]">© 2025 2ndShift Technologies Pvt. Ltd.</p>
          </div>
        </div>
      </footer>
    </div>
